...
contract ContractTest is DSTest {
    ...
    function testExploit() public {
        ...
        emit log_named_decimal_uint("[Start] Attacker WBNB Balance", WBNB.balanceOf(address(this)), 18);
        emit log_named_decimal_uint("[Start] Attacker BUSD Balance", BUSD.balanceOf(address(this)), 18);
        emit log_named_decimal_uint("[Start] Attacker USDC Balance", USDC.balanceOf(address(this)), 18);
        ...
        emit log_named_decimal_uint("[End] Attacker USDT Balance", USDT.balanceOf(address(this)), 18);
        emit log_named_decimal_uint("[End] Attacker WBNB Balance", WBNB.balanceOf(address(this)), 18);
        emit log_named_decimal_uint("[End] Attacker BUSD Balance", BUSD.balanceOf(address(this)), 18);
        emit log_named_decimal_uint("[End] Attacker USDC Balance", USDC.balanceOf(address(this)), 18);
    }
